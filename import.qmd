...
id - dbl,group - chr, weight - dbl, age - dbl, fat - dbl
...
```{r}
# Your answer in code
readr::read_delim("data/blood_fat.csv", show_col_types = FALSE,col_types = cols('age' = col_integer(), 'id' = col_integer()))
...
readr::read_delim("data/blood_fat.csv", show_col_types = FALSE,col_types = cols('age' = col_integer(), 'id' = col_integer(), 'weight' = col_skip()))
